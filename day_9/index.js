...
function share() {
	window.open(
		`https://www.twitter.com/share?text=I made ${score} points in the Push Force game created by @bobbyenomate. 
        Check it out here! 😃&hashtags=100Days100Projects&url=https://codepen.io/FlorinPop17/full/JjPVBwx`,
		'_blank'
	);
}
